...
interface TextComponent
  ...
  Currency: React.ForwardRefExoticComponent<
    Props & React.RefAttributes<RNText>
  >;
}
...
const Bold: React.ForwardRefExoticComponent<
  Props & React.RefAttributes<RNText>
> = React.forwardRef((props: Props, ref: React.Ref<RNText>) => {
  const {children, style, link, error, testID, accessibilityLabel} = props;
  return (
    <RNText
      ref={ref}
